...
- (void)setImage:(UIImage *)image
{
    ...
    [self.imageView sizeToFit];   // update the frame of the UIImageView 調整image的size
...
{
    self.image = nil;//下載一個new image時,先清空原本的image
    ...
    if (self.imageURL)
    {
        ...
        // another configuration配置結構 option is backgroundSessionConfiguration (multitasking API required though)
